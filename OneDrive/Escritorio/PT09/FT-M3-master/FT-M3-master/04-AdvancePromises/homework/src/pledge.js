          ...
          if(this._state === 'fulfilled'){
              ...
              if(!handler.successCb){
               ...
               try {
                  ...
                  //si arroja error este  successCB el try no lo ejecuta
                  if(result instanceof $Promise){
                     // es x que handler devolvio una promesa
                     result.then(value => {handler.downstreamPromise._internalResolve(value)},
           ...
           if(!handler.errorCb){
               ...
               try {
                  ...
                  //si arroja error este  errorCB el try no lo ejecuta
                  if(result instanceof $Promise){
                     // es x que handler devolvio una promesa
                     result.then(value => {handler.downstreamPromise._internalResolve(value)},
                     err => {handler.downstreamPromise._internalReject(err)})
